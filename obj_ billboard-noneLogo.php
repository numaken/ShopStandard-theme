...
<section class="branding">
    ...
    if ($imgurl == null){
        ...
        echo '<a class="navbar-brand" href="' . $url . '" style="background-color:' . $back_color4 . '"><img class="brand-logo navbar-brand-center" src="' . $obj['bottom_patch_url'] . '" height="" width="" alt="" />' . '</a>';
        echo '<a class="navbar-text" href="' . $url . '">' . '<img class="MainVisual__logoImg img-responsive hidden-xs" src="' . $obj['logo_icon_url'] . '" width="245" alt="ロゴイメージ">' . '</a>';
    ...
    <ul class="nav navbar-right nav-address">
        ...
        <li><h4 class="pull-right hidden-xs"><?php echo $obj['address']; ?></h4></li>
        <li><h3><span data-action="call" data-tel="<?php echo $obj['tel']; ?>"><i class="fas fa-phone-square"></i>&nbsp;<?php echo $obj['tel']; ?></span></h3></li>
...
<div id="myCarousel" class="carousel slide  carousel-fade" data-ride="carousel">
    ...
    <div class="carousel-inner">
        ...
        $imgback_url = null;
        $imgback_url = wp_get_attachment_image_src($background_image1, 'full'); //サイズは自由に変更してね
        if ($imgback_url == null){
            // 画像が無い場合の処理

            echo '<div class="item active bgImage" style="background-image:url(\'' . $osusume[0]['image'] . '\'); height:645px;" alt="' . $osusume[0]['title'] . '" >';

        }else{

            echo '<div class="item active bgImage" style="background-image:url(\'' . $imgback_url[0] . '\'); height:645px;" alt="' . $osusume[0]['title'] . '" >';
        ...
        <div class="carousel-caption">
            ...
            if ($caption1 == null){
                ...
                if ($recommend1_btn_name == null){

                    echo '<a href="' . $recommend1_btn_url . '/" class="btn btn-danger" style="background-color:' . $recommend1_btn_color . ';">詳細を見る</a>';
    ...
    $imgback_url = null;
    $imgback_url = wp_get_attachment_image_src($background_image2, 'full'); //サイズは自由に変更してね
    if ($imgback_url == null){
        // 画像が無い場合の処理

        echo '<div class="item bgImage" style="background-image:url(\'' . $osusume[1]['image'] . '\'); height:645px;" alt="' . $osusume[1]['title'] . '" >';

    }else{

        echo '<div class="item bgImage" style="background-image:url(\'' . $imgback_url[0] . '\'); height:645px;" alt="' . $osusume[1]['title'] . '" >';
    }
    ...
    <div class="carousel-caption">
        ...
        if ($caption2 == null){
            ...
            if ($recommend2_btn_name == null){

                echo '<a href="' . $recommend2_btn_url . '/" class="btn btn-danger" style="background-color:' . $recommend2_btn_color . ';">詳細を見る</a>';
...
<?php
    ...
    $imgback_url = null;
    $imgback_url = wp_get_attachment_image_src($background_image3, 'full'); //サイズは自由に変更してね
    if ($imgback_url == null){
        // 画像が無い場合の処理

        echo '<div class="item bgImage" style="background-image:url(\'' . $osusume[2]['image'] . '\'); height:645px;" alt="' . $osusume[1]['title'] . '" >';

    }else{

        echo '<div class="item bgImage" style="background-image:url(\'' . $imgback_url[0] . '\'); height:645px;" alt="' . $osusume[2]['title'] . '" >';
    }
...
?>
    ...
    <div class="carousel-caption">
        ...
        if ($caption3 == null){
            ...
            if ($recommend3_btn_name == null){

                echo '<a href="' . $recommend3_btn_url . '/" class="btn btn-danger" style="background-color:' . $recommend3_btn_color . ';">詳細を見る</a>';
