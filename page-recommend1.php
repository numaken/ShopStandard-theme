    ...
    <main id="main">
        ...
        <div id="myCarousel" class="carousel slide  carousel-fade" data-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <?php
                    $imgback_url = wp_get_attachment_image_src($img1, 'full'); //サイズは自由に変更してね
                    if ($imgback_url == null){
                        // 画像が無い場合の処理
                ...
                <div class="billboard-caption">
                    ...
                    if ($billboard_title1 == null){
                        ...
                        echo '<h3 class="ta-center">' . $billboard_title1 . '</h3>';
                    }
                    ?>
                    ...
                    if ($caption1 == null){
                        ...
                        echo '<h4 class="ta-center">' . $caption1 . '</h4>';
                    }
                    ?>
                        ...
                        <div class="panel-body">
                                ...
                                <?php
                                    ...
                                    if (function_exists('has_post_thumbnail') AND has_post_thumbnail($post->ID)) {
                                            ...
                                            echo '<img class="img-responsive" src="' . $osusume[0]['image'] . '"  width="100%" alt="">';
                                          }
                                ?>
                                ...
                                <div class="col-xs-12 cl-sm-12 col-md-12 col-lg-12">
                                    ...
                                    <div class="entry-header">
                                        <h3 class="heading recommend-title"><? echo $osusume[0]['title']; ?></h3>
                                    </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                ...
                                <div class="entry-header">
                                    <h3 class="heading recommend-title" style="color:<? echo $title_color1; ?>"><? echo $osusume[1]['title']; ?></h3>
                                </div>
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <div class="content" style="color:<? echo $font_color1; ?>"><? echo $osusume[1]['description']; ?></div>
                                    </div>
                                </div>
