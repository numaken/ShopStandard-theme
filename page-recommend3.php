    ...
    <main id="main">
        ...
        <div id="myCarousel" class="carousel slide  carousel-fade" data-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <?php
                $imgback_url = wp_get_attachment_image_src($img3, 'full'); //サイズは自由に変更してね
                if ($imgback_url == null){
                    // 画像が無い場合の処理
                    echo '<div class="item active bgImage" style="background-image:url(\'' . $osusume[2]['image'] . '\');" alt="' . $osusume[1]['title'] . '" >';
                }else{
                ...
                <div class="billboard-caption">
                    ...
                    if ($billboard_title3 == null){
                        ...
                        echo '<h3 class="ta-center">' . $billboard_title3 . '</h3>';
                    }
                    ?>
                    ...
                    if ($caption3 == null){
                        ...
                        echo '<h4 class="ta-center">' . $caption3 . '</h4>';
                    }
                    ?>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        if (function_exists('has_post_thumbnail') AND has_post_thumbnail($post->ID)) {
                            ...
                            echo '<img class="img-responsive" src="' . $osusume[2]['image'] . '"  width="100%" alt="">';
                        }
                        ?>
                    ...
                    <div class="col-xs-12 cl-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="entry-header">
                            <h3 class="heading recommend-title"><? echo $osusume[2]['title']; ?></h3>
                        </div>
                    ...
                    <div class="col-xs-12 cl-sm-7 col-md-7 col-lg-7">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                            ...
                            <h3 class="heading recommend-title" style="color:<? echo $title_color2; ?>"><? echo $osusume[1]['title']; ?></h3>
                            <div class="media">
                                <a href="<?php echo esc_url( home_url( '/' ) ); ?>recommend2/">
                                        ...
                                        if ($imgurl == null){
                                            ...
                                            echo '<img alt="64x64" class="media-object" data-src="holder.js/64x64" src="' . $osusume[1]['image'] . '" alt="' . $osusume[1]['title'] . '" data-holder-rendered="true" style="width: 100%;">';

                                        }else{

                                            echo '<img alt="64x64" class="media-object" data-src="holder.js/64x64" src="' . $imgurl[0] . '" alt="' . $osusume[1]['title'] . '" data-holder-rendered="true" style="width: 100%;">';
                                        }
                                ...
                                <div class="media-body">
                                    <div class="content" style="color:<? echo $font_color2; ?>"><? echo $osusume[1]['description']; ?></div>
                                </div>
                            </div>
